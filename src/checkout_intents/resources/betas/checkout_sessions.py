...
from ...types.betas.checkout_session_create_response import CheckoutSessionCreateResponse
...
class CheckoutSessionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          buyer: Make all properties in T optional
        ...
        return self._post(
            ...
            cast_to=CheckoutSessionCreateResponse,
        )
