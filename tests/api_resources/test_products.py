...
class TestProducts:
    ...
    @parametrize
    def test_method_list_subscriptions(self, client: CheckoutIntents) -> None:
        product = client.products.list_subscriptions()
        assert_matches_type(ProductListSubscriptionsResponse, product, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_list_subscriptions(self, client: CheckoutIntents) -> None:
        response = client.products.with_raw_response.list_subscriptions()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_list_subscriptions(self, client: CheckoutIntents) -> None:
        with client.products.with_streaming_response.list_subscriptions() as response:
...
class TestAsyncProducts:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_subscriptions(self, async_client: AsyncCheckoutIntents) -> None:
        product = await async_client.products.list_subscriptions()
        assert_matches_type(ProductListSubscriptionsResponse, product, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_list_subscriptions(self, async_client: AsyncCheckoutIntents) -> None:
        response = await async_client.products.with_raw_response.list_subscriptions()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_list_subscriptions(self, async_client: AsyncCheckoutIntents) -> None:
        async with async_client.products.with_streaming_response.list_subscriptions() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
