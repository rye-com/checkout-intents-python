...
from checkout_intents import CheckoutIntents, AsyncCheckoutIntents, APIResponseValidationError
from checkout_intents._types import Omit
from checkout_intents._utils import asyncify
from checkout_intents._models import BaseModel, FinalRequestOptions
from checkout_intents._exceptions import (
    APIStatusError,
    APITimeoutError,
    CheckoutIntentsError,
    APIResponseValidationError,
)
from checkout_intents._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: CheckoutIntents | AsyncCheckoutIntents) -> int:
...
class TestCheckoutIntents:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
    ...
    def test_copy(self, client: CheckoutIntents) -> None:
        copied = client.copy()
    ...
    def test_copy_default_options(self, client: CheckoutIntents) -> None:
    ...
    def test_copy_signature(self, client: CheckoutIntents) -> None:
    ...
    def test_copy_build_request(self, client: CheckoutIntents) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "checkout_intents/_legacy_response.py",
                        "checkout_intents/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "checkout_intents/_compat.py",
    ...
    def test_request_timeout(self, client: CheckoutIntents) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CheckoutIntentsError):
            with update_env(**{"CHECKOUT_INTENTS_API_KEY": Omit()}):
                client2 = CheckoutIntents(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_hardcoded_query_params_in_url(self, client: CheckoutIntents) -> None:
    ...
    def test_request_extra_json(self, client: CheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: CheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: CheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
    ...
    def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, client: CheckoutIntents
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(CHECKOUT_INTENTS_BASE_URL="http://localhost:5000/from/env"):
            client = CheckoutIntents(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(CHECKOUT_INTENTS_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                CheckoutIntents(api_key=api_key, _strict_response_validation=True, environment="staging")
    ...
    def test_base_url_trailing_slash(self, client: CheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: CheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: CheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = CheckoutIntents(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = CheckoutIntents(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = CheckoutIntents(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: CheckoutIntents
    ) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: CheckoutIntents, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: CheckoutIntents) -> None:
...
class TestAsyncCheckoutIntents:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncCheckoutIntents) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncCheckoutIntents) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncCheckoutIntents) -> None:
    ...
    def test_copy_default_options(self, async_client: AsyncCheckoutIntents) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncCheckoutIntents) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncCheckoutIntents) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncCheckoutIntents) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        test_client = AsyncCheckoutIntents(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        request = test_client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "bar"
        ...
        test_client2 = AsyncCheckoutIntents(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CheckoutIntentsError):
            with update_env(**{"CHECKOUT_INTENTS_API_KEY": Omit()}):
                client2 = AsyncCheckoutIntents(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncCheckoutIntents) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncCheckoutIntents) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncCheckoutIntents) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_env(self) -> None:
        with update_env(CHECKOUT_INTENTS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncCheckoutIntents(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(CHECKOUT_INTENTS_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncCheckoutIntents(api_key=api_key, _strict_response_validation=True, environment="staging")
    ...
    async def test_base_url_trailing_slash(self, client: AsyncCheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncCheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncCheckoutIntents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncCheckoutIntents(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncCheckoutIntents(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncCheckoutIntents(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncCheckoutIntents
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncCheckoutIntents,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncCheckoutIntents, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncCheckoutIntents) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncCheckoutIntents) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
